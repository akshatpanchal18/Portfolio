...
const demoProjects = [
  {
    title: "Temp-Mail",
    category: "Temporary Mail Service",
    imgSrc: "/email.png",
  ...
  },
  {
    ...
    imgSrc: "/chatbot1.png",
    link: "https://chat-application-frontend-uajp.onrender.com/",
  },
  {
    title: "ENQCODE",
          ...
          >
            <div className="bg-white rounded-2xl overflow-hidden relative">
              ...
              <div className="absolute bottom-0 right-0">
                <button
                  className="bg-gray-100 text-black group-hover:text-white px-8 py-4 rounded-tl-xl group-hover:bg-indigo-500 transition-all duration-300"
